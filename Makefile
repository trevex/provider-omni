# ====================================================================================
# Setup Project
PROJECT_NAME := provider-omni
PROJECT_REPO := github.com/trevex/$(PROJECT_NAME)
...
xpkg.build.provider-omni: do.build.images
...
# This target prepares repo for your provider by replacing all "omni"
