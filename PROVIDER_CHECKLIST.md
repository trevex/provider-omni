...
The [provider-omni](https://github.com/trevex/provider-omni) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/trevex/provider-omni/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/trevex/provider-omni/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/trevex/provider-omni/blob/main/hack/boilerplate.go.txt](https://github.com/trevex/provider-omni/blob/main/hack/boilerplate.go.txt)
...
The [provider-omni](https://github.com/trevex/provider-omni)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/trevex/provider-omni/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/trevex/provider-omni/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue omnis (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/trevex/provider-omni/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Omnis: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/trevex/provider-omni/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
